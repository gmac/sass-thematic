...
function compileThematic(opts, done) {
  AST.parse(opts, function(err, result) {
    ...
    sass.render({data: formatASTResult.call(opts.context, result)}, done);
  });
}
 ...
 */
function formatASTResult(result) {
...
module.exports = function(content) {
  ...
  if (isSync) {
    try {
      ...
      result = sass.renderSync({data: formatASTResult.call(this, result)});
