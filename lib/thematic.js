...
ThematicParser.prototype = {
  ...
  */
  _sassCSSOptions: function() {
    this.loadThemeData();
    if (typeof this.sassOptions !== 'object') {
      this.sassOptions = {};
    }

    return extend(this.sassOptions, {
      data: [
        '$sass-thematic:"css";',
        this.themeData,
        this.toString()
  ...
  * @private
  */
  _renderCSS: function(done) {
    var isSync = (typeof done !== 'function');
    var sass = require('node-sass');
    var opts = this._sassCSSOptions();
  ...
  * @private
  */
  _renderTemplate: function(done) {
    var isSync = (typeof done !== 'function');
    var sass = require('node-sass');
    var opts = this._sassTemplateOptions();
    var self = this;
