...
var Node = {
  toString: function(node) {
    return GonzalesNode.prototype.toString.call(node);
  },
...
SassThematic.prototype = {
  ...
  */
  ...
  /**
  * Prunes the SassThematic instance AST.
  * All non-themed rules and declarations will be eliminated.
  * @param {Object} [options] pruning options.
  * Accepts `template: true` for template parsing.
  * @returns {SassThematic} self reference.
  */
  prune: function(opts) {
    this._template = (opts && opts.template) || false;
